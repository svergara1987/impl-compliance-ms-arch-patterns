...
public class Wrapper {
	...
	public void initialisation (Endpoints endpoints, HealthApis health_apis, SetString last_endpoint_active_query_result, SetString last_health_query_result, SetString services, Integer time, SetString unavailable_endpoints) {
		throw new RuntimeException("code not implemented yet");
	}
		
	public Boolean isValid (Endpoints endpoints, HealthApis health_apis, SetString last_endpoint_active_query_result, SetString last_health_query_result, SetString services, Integer time, SetString unavailable_endpoints) {
		throw new RuntimeException("code not implemented yet");
	}
