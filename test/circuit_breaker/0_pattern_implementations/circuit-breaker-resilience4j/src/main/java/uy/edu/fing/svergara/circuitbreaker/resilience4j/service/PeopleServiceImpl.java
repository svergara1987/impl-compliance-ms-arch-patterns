...
import uy.edu.fing.svergara.circuitbreaker.resilience4j.exception.NullParametersException;
import uy.edu.fing.svergara.circuitbreaker.resilience4j.exception.PersonNotFoundException;
...
public class PeopleServiceImpl implements PeopleService {
	...
	@Override
	public Supplier<ResponseEntity<Object>> listSuppplier(Integer delayInMilliseconds, Boolean fail) {
		return () -> {
